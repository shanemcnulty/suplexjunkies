    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(default=datetime.datetime(2016, 1, 11, 12, 24, 0, 349315, tzinfo=utc))),
            ],
        ),
        migrations.CreateModel(
            name='Subject',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('name', models.CharField(max_length=254)),
                ('created_at', models.DateTimeField(default=datetime.datetime(2016, 1, 11, 12, 24, 0, 348625, tzinfo=utc))),
